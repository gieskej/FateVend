...
export const NAME_POOLS = {
  ...
  'Human': {
    masc:    ['Marcus', 'Daven', 'Kofi', 'Soren', 'Riku', 'Emre', 'Luca', 'Tariq', 'Finn', 'Jesper',
              ...
              'Arjun', 'Bo', 'Cormac', 'Dmitri', 'Enzo', 'Faisal', 'Gustaf', 'Hamid', 'Ionut', 'Jamal'],
    fem:     ['Sera', 'Nadia', 'Keiko', 'Amara', 'Linh', 'Priya', 'Zara', 'Ines', 'Cleo', 'Tamsin',
              ...
              'Anaya', 'Beatriz', 'Chiara', 'Dovile', 'Elin', 'Farida', 'Gulnara', 'Hana', 'Ingrid', 'Jocelyn'],
    ...
    last:    ['Vasquez', 'Okafor', 'Tanaka', 'Reyes', 'Petrov', 'Adeyemi', 'Chen', 'Novak', 'Diallo', 'Larsen',
              ...
              'Santos', 'Torres', 'Nwosu', 'Hashimoto', 'Leclerc', 'Ibarra', 'Kato', 'Andrade', 'Molina', 'Oduya',
              'Aguilar', 'Boateng', 'Castellano', 'Duarte', 'Eriksson', 'Farrow', 'Giannopoulos', 'Haddad', 'Ivanova', 'Jankowski'],
  },
  ...
  'Cyborg': {
    masc:    ['Brak', 'Venn', 'Holt', 'Dax', 'Sev', 'Cas', 'Ryn', 'Tor', 'Kell', 'Mace',
              ...
              'Anvil', 'Bolt', 'Crank', 'Din', 'Ferrous', 'Gear', 'Halyard', 'Iridium', 'Jack', 'Kilo'],
    fem:     ['Vex', 'Ryke', 'Zenn', 'Cass', 'Dace', 'Syla', 'Kira', 'Nyx', 'Brix', 'Tayne',
              ...
              'Amp', 'Brill', 'Chrome', 'Dynia', 'Enna', 'Flick', 'Glaze', 'Halcyon', 'Iridia', 'Jynx'],
    ...
    last:    ['Vane', 'Strix', 'Coldrun', 'Ironsides', 'Hardwire', 'Nullbright', 'Greyframe', 'Voidmark', 'Steelrun', 'Coldweld',
              ...
              'Ashwire', 'Boltframe', 'Circuitborn', 'Dredgeport', 'Enginerun', 'Fusevane', 'Gridlock', 'Halfweld', 'Ionmark', 'Jointrun'],
  },
  ...
  'Android': {
    masc:    ['Aden', 'Caelum', 'Doran', 'Elias', 'Felix', 'Garen', 'Hale', 'Ivan', 'Jasper', 'Kael',
              ...
              'Aurelio', 'Barnabus', 'Corvus', 'Demetrios', 'Evander', 'Fabian', 'Griffon', 'Horatio', 'Icarus', 'Jonquil'],
    fem:     ['Ada', 'Blythe', 'Clara', 'Dara', 'Evren', 'Faye', 'Grace', 'Hana', 'Iris', 'June',
              ...
              'Aurelia', 'Belisama', 'Cyra', 'Delphine', 'Elowen', 'Fiorenza', 'Griselda', 'Hesperia', 'Isolde', 'Junia'],
    ...
    last:    ['Unit-7', 'Designation-Alpha', 'Model-V', 'Series-9', 'Prototype', 'Revision-3', 'Batch-12', 'Instance', 'Construct', 'Synthesis',
              ...
              'Algorithm', 'Baseline', 'Codex', 'Datastream', 'Engram', 'Framework', 'Gestalt', 'Hologram', 'Interface', 'Juncture'],
  },
  ...
  'Uplifted': {
    masc:    ['Kito', 'Baraka', 'Ebo', 'Jomo', 'Kofi', 'Leti', 'Mazi', 'Nuru', 'Ode', 'Paka',
              ...
              'Ade', 'Bem', 'Choko', 'Dembe', 'Enzi', 'Furaha', 'Goma', 'Huru', 'Ita', 'Jengo'],
    fem:     ['Amani', 'Bisa', 'Chari', 'Dala', 'Elia', 'Fara', 'Gara', 'Haba', 'Imara', 'Jina',
              ...
              'Aiyana', 'Bahati', 'Chiku', 'Dziko', 'Efia', 'Furaha', 'Goma', 'Huda', 'Imani', 'Jamila'],
    ...
    last:    ['Project-Chimera', 'Batch-Uplift-3', 'Cohort-Seven', 'Lineage-Prime', 'Strain-Kappa', 'Generation-Two', 'Programme-End', 'Trial-Nine', 'Vector-Six', 'Source-Null',
              ...
              'Loftstrain', 'Mendline', 'Nurturebatch', 'Overwatch-Strain', 'Progenyline', 'Questbatch', 'Riseborn', 'Splicestock', 'Threshline', 'Upliftborn'],
  },
  ...
  'Clone': {
    masc:    ['Davan', 'Erek', 'Foran', 'Gael', 'Haran', 'Iren', 'Jaran', 'Keren', 'Laran', 'Maran',
              ...
              'Adran', 'Boran', 'Cyran', 'Duran', 'Ekran', 'Fenran', 'Goran', 'Hedran', 'Ikran', 'Jodran'],
    fem:     ['Dava', 'Ereka', 'Fora', 'Gaela', 'Hara', 'Irena', 'Jara', 'Kera', 'Lara', 'Mara',
              ...
              'Adra', 'Bora', 'Cyra', 'Dura', 'Ekra', 'Fenra', 'Gora', 'Hedra', 'Ikra', 'Jodra'],
    ...
    last:    ['Copy-One', 'Strand-A', 'Print-2', 'Facsimile', 'Duplicate', 'Replica', 'Simulacrum', 'Mirror', 'Ditto', 'Double',
              ...
              'Origincopy', 'Parallelform', 'Quotedline', 'Restrand', 'Sameform', 'Twincopy', 'Underline-2', 'Vatgrown', 'Wombprint', 'Xerox-Line'],
  },
  ...
  'Mutant': {
    masc:    ['Dex', 'Kren', 'Vorr', 'Slake', 'Bane', 'Crux', 'Dent', 'Fell', 'Gash', 'Hern',
              ...
              'Clot', 'Drek', 'Fetch', 'Grub', 'Hulk', 'Jolt', 'Krag', 'Lich', 'Mange', 'Node'],
    fem:     ['Ash', 'Blight', 'Char', 'Dreg', 'Envy', 'Flux', 'Grit', 'Haze', 'Ire', 'Jade',
              ...
              'Ache', 'Bane', 'Cinder', 'Deform', 'Ebb', 'Fret', 'Gall', 'Hex', 'Itch', 'Jag'],
    ...
    last:    ['Ashfall', 'Blightborn', 'Charmark', 'Driftborn', 'Exposed', 'Fluxborn', 'Greymark', 'Hazemark', 'Ironmark', 'Jademark',
              ...
              'Ashscar', 'Blistermark', 'Corrodeborn', 'Direborn', 'Emberrot', 'Feralmark', 'Gnashborn', 'Hollowscar', 'Infectborn', 'Jawrend'],
  },
  ...
  'Alien': {
    masc:    ['Vraek', 'Shael', 'Dhonn', 'Urath', 'Lhyen', 'Zhovar', 'Thyss', 'Kraen', 'Vhorak', 'Aresh',
              ...
              'Xhoran', 'Yvael', 'Zorath', 'Aqel', 'Brenak', 'Chovel', 'Drazek', 'Eshvan', 'Frovek', 'Grendal'],
    fem:     ['Vraeki', 'Shaela', 'Dhonna', 'Urathi', 'Lhyeni', 'Zhovara', 'Thyssa', 'Kraeni', 'Vhoraki', 'Areshi',
              ...
              'Xhorani', 'Yvaeli', 'Zorathi', 'Aqeli', 'Brenaki', 'Choveli', 'Drazeki', 'Eshvani', 'Froveki', 'Grendali'],
    ...
    last:    ['Vorath-Seven', 'Dhael-Prime', 'Kresh-Null', 'Lhyen-Three', 'Urath-Origin', 'Vraek-Line', 'Shaen-Root', 'Thys-End', 'Aresh-Deep', 'Ohren-Far',
              ...
              'Xhoran-Deep', 'Yvael-Root', 'Zorath-Line', 'Aqel-Far', 'Brenak-Wake', 'Chovel-Path', 'Drazek-Vein', 'Eshvan-Course', 'Frovek-Shore', 'Grendal-Mark'],
  },
