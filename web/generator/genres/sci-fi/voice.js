...
export function outputRules(sk) {
  ...
  const characterEntryOpen = isIndustrial
    ...
    : 'Open with one sentence: "[Full name] is a [age]-year-old [orientation] [gender] [species/race] with [hair, fur, feathers, or other head/body covering appropriate to their actual species — omit if their species has none], [eye color] eyes, [skin, scales, carapace, or surface texture appropriate to their species][, and any visible augmentations, scars, or markings if notable], wearing [outfit or gear suited to their role and economic tier — omit if their species doesn\'t wear clothing]."';
  const appearanceBody = isIndustrial
    ...
    : "species and augmentation description, age range, gender, body type, hair/fur/feathers/scales or other surface covering appropriate to their actual species, eyes, cybernetic features if any, clothing and equipment suited to their role and economic tier (omit if their species doesn't wear clothing), setting mood.";
...
"npcEntries": An object where every key is an NPC name and every value is a PLAIN STRING (not a nested object). Each string MAX 1000 chars. Open with one sentence: "[Full name] is a [age]-year-old [orientation] [gender] [species/race] with [hair, fur, feathers, or other head/body covering appropriate to their actual species — omit if their species has none], [eye color] eyes, [skin, scales, carapace, or surface texture appropriate to their species][, and any visible augmentations, scars, or markings if notable], wearing [outfit or gear suited to their role — omit if their species doesn't wear clothing]." Then describe personality, quirks, habits, occupation, and their relationship with the protagonist and others by name. Do not repeat the situation or plot.
