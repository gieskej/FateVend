"""
Generate sci-fi genre icons via SD WebUI Forge API.
Reads iconPrompt / iconPath pairs from all JS files in genres/sci-fi/.
...
GENRE_PROMPT = "A man kissing a blue alien girl with antennae, Neo Tokyo background, sci-fi digital art"
