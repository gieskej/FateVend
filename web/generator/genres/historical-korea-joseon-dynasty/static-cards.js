// genres/historical-korea-joseon-dynasty/static-cards.js
...
export const STATIC_RACES = [
  ...
  },
  {
    ...
    entry:
      "Called Wae by the Joseon court, the people across the strait were a source of both trade and trauma — the devastating Imjin War invasions of 1592–98 left scars that shaped Joseon foreign policy for the rest of the dynasty. Contact afterward was tightly controlled, funneled almost entirely through the walled Waegwan trading post at Busan.",
  },
  {
    name: "Mongols",
    triggers: "Mongol, Mongols, Mongolian",
    entry:
      "Steppe peoples to the north and west, remembered in Joseon largely through the still-bitter memory of the Mongol Empire's decades-long domination of the preceding Goryeo dynasty. By the Joseon era few Mongols were seen directly, but the word still carried connotations of steppe warfare, subjugation, and wariness of the wide northern frontier.",
  },
  {
    name: "Jurchen",
    triggers: "Jurchen, Jurchens",
    entry:
      "Semi-nomadic peoples of the Manchurian frontier, alternately trading partners, tributaries, and raiders along Joseon's northern border for most of the dynasty's history. Their eventual unification under Nurhaci reshaped the entire region — the Jurchen tribes of the frontier became, within a generation, the Manchu rulers of the Qing empire.",
  },
  {
    name: "Ryukyuan",
    triggers: "Ryukyuan, Ryukyu, Ryukyu Kingdom",
    entry:
      "Traders and envoys from the Ryukyu Kingdom, a small maritime state to the south in what is now Okinawa, who occasionally reached Joseon's shores with goods and news from further afield — a rare, exotic point of contact with a world beyond China and Japan.",
  },
];
...
export const STATIC_LOCATIONS = [
  ...
  },
  {
    ...
    entry:
      "The highest state-sponsored Confucian academy in Joseon Korea, training the scholars who would go on to sit the gwageo civil service examinations. Students lived and studied on campus for years, and the rivalries, friendships, and reputations forged there often shaped the rest of a scholar-official's career.",
  },
  {
    name: "Bukchon",
    triggers: "Bukchon, Bukchon Hanok Village",
    entry:
      "The aristocratic quarter of Hanyang, nestled between Gyeongbokgung and Changdeokgung. Home to generations of yangban clans in walled hanok compounds along narrow, winding lanes — a neighborhood where proximity to the palace was itself a mark of status, and every family's standing was silently measured by the height of their gate.",
  },
  {
    name: "Jongno",
  ...
  },
  {
    ...
    triggers: "Pyongyang",
    entry:
      "The great northern provincial capital, gateway to the trade routes into Manchuria and Qing China. A garrison city as much as a commercial one, with a culture shaped by its exposure to the frontier — harder-edged than the south, and always the first to feel the tremors of trouble across the border.",
  },
  {
    name: "Busan",
    triggers: "Busan, Busan Port, Waegwan",
    entry:
      "The southern sea gate of Joseon Korea, where Korean merchants dealt with Japanese traders confined to the walled Waegwan (Japan House) trading post. One of the kingdom's only sanctioned points of contact with Japan, and a place where diplomacy, smuggling, and quiet espionage all wore the same polite face.",
  },
];
...
export const STATIC_FACTIONS = [
  {
    ...
    entry:
      "A faction of scholar-officials who present themselves as guardians of Confucian moral integrity, rooting out corruption and factional cronyism wherever they find it — or claim to find it. Their righteousness makes them formidable allies and even more dangerous enemies, since an accusation of corruption from the Cheongnyu is difficult to survive politically, whether or not it's true.",
  },
  {
    name: "The Hwang Consortium",
    triggers: "Hwang Consortium",
    entry:
      "A loose alliance of powerful clans and their client officials, more concerned with land, marriage alliances, and influence than with any particular ideology. Where the Cheongnyu preach reform, the Hwang Consortium simply outlasts it — every purge in living memory has thinned their ranks and left the rest more entrenched.",
  },
  {
    name: "Amun-hoe",
    triggers: "Amun-hoe, Shadow Gate Society",
    entry:
      "A smuggling syndicate that moves contraband, banned books, and information through the back alleys of Jongno and the docks at Namdaemun and Busan. Officially, no such organization exists; unofficially, everyone from beggars to minor nobles knows exactly who to bribe when something needs to disappear — or appear — quietly.",
  },
  {
    name: "The Ginseng Road Compact",
    triggers: "Ginseng Road Compact",
    entry:
      "A secretive guild of merchants controlling the immensely profitable wild ginseng trade along the routes into Qing China. Their wealth rivals many yangban households, and their border contacts make them an unofficial intelligence network the government quietly tolerates — so long as the right officials keep receiving the right gifts.",
  },
  {
    name: "The Red Sickles",
    triggers: "Red Sickles",
    entry:
      "A ruthless street gang of former farmers turned thieves and thugs known for wielding rusty sickles.",
  },
];
