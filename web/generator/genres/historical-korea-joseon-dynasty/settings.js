...
export const TAG_POOLS = {
  ...
  professionTags: {
    ...
    "Royal Consort": ["consort", "rivalry", "court-intrigue", "palace"],
    "Royal Inspection": ["corruption", "undercover", "justice", "secret"],
    "Royal Secretariat": ["court", "governance", "confucian", "duty"],
    "Folk Medicine": ["medicine", "village", "herbs", "healing"],
    Constabulary: ["justice", "arrest", "patrol", "village"],
