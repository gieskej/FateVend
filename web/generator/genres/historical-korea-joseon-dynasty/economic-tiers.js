...
export const ECONOMIC_TIERS = {
  1: {
    ...
    iconPrompt:
      "joseon dynasty korean destitute nobi servant cold winter carrying load landowner compound poverty suffering traditional minhwa folk painting",
    iconPath:
      "generator/genres/historical-korea-joseon-dynasty/icons/ECONOMIC_TIERS#tier1-destitute.webp",
  },
  2: {
    label: "Subsistence",
    descriptors: [
    ...
    iconPrompt:
      "joseon dynasty korean subsistence farmer thatched chogajip cottage barley meal plain hanbok modest hardship traditional minhwa folk painting",
    iconPath:
      "generator/genres/historical-korea-joseon-dynasty/icons/ECONOMIC_TIERS#tier2-subsistence.webp",
  },
  3: {
    label: "Modest",
    descriptors: [
    ...
    iconPrompt:
      "joseon dynasty korean modest commoner artisan market clean hanbok tile roof courtyard comfortable ordinary traditional folk painting",
    iconPath:
      "generator/genres/historical-korea-joseon-dynasty/icons/ECONOMIC_TIERS#tier3-modest.webp",
  },
  4: {
    label: "Established",
    descriptors: [
    ...
    iconPrompt:
      "joseon dynasty korean established yangban official silk hanbok tile compound inner courtyard horse servants formal traditional painting",
    iconPath:
      "generator/genres/historical-korea-joseon-dynasty/icons/ECONOMIC_TIERS#tier4-established.webp",
  },
  5: {
    label: "Elite",
    descriptors: [
    ...
    iconPrompt:
      "joseon dynasty korean elite yangban high official grand clan compound silk robes gat hat ceremony servants dignified imposing traditional court painting",
    iconPath:
      "generator/genres/historical-korea-joseon-dynasty/icons/ECONOMIC_TIERS#tier5-elite.webp",
  },
};
