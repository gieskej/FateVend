...
"characterEntry": MAX 1000 chars. Open with one sentence: "[Full name] is a [age]-year-old [orientation] [gender] of [class/clan] with [hair length] [hair color] [hair style], [eye color] eyes, [skin tone] skin[, and any jewelry, pins, or ornaments appropriate to their station if notable], wearing [hanbok or garment suited to their class and occupation]." Then describe personality, quirks, habits, occupation, and relationships with family and key cast members by name. Do not repeat the situation, conflict, or plot already covered in the description, opening, or plot essentials.

"npcEntries": An object where every key is an NPC name and every value is a PLAIN STRING (not a nested object). Each string MAX 1000 chars. Open with one sentence: "[Full name] is a [age]-year-old [orientation] [gender] of [class/clan] with [hair length] [hair color] [hair style], [eye color] eyes, [skin tone] skin[, and any jewelry, pins, or ornaments appropriate to their station if notable], wearing [hanbok or garment suited to their class and occupation]." Then describe personality, quirks, habits, occupation, and their relationship with the protagonist and others by name. Do not repeat the situation or plot.
