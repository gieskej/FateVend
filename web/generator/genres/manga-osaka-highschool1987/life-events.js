...
// Formative events for Osaka high school students, circa 1987.

export const LIFE_EVENTS = [
  {
    id: 'lost_parent_early',
    description: 'Lost a parent before middle school — shaped everything that came after',
    toneTag: 'dramatic',
  ...
  {
    id: 'parents_divorced',
    description: 'Parents divorced — still unusual in 1987 Japan, and the social stigma followed',
    toneTag: 'dramatic',
  ...
  },
  {
    ...
    description: 'Failed the entrance exam for their first-choice high school — ended up here by default',
    toneTag: 'neutral',
  ...
  {
    id: 'koshien_loss',
    description: 'Was on the team that lost Koshien prefectural finals in middle school — one out from going',
    toneTag: 'dramatic',
  ...
  {
    id: 'first_arubaito',
    description: 'Started working part-time at twelve to help the family — grew up faster than their classmates',
    toneTag: 'gritty',
  ...
  {
    id: 'moved_from_tokyo',
    description: 'Transferred from Tokyo — the Osaka culture is different and people keep pointing it out',
    toneTag: 'neutral',
  ...
  },
  {
    ...
    description: 'Witnessed something involving yakuza in Namba that they were not supposed to see',
    toneTag: 'gritty',
  ...
  {
    id: 'prodigy_faded',
    description: 'Was considered a prodigy in primary school — piano, mathematics, or art — the pressure faded but the expectations never did',
    toneTag: 'neutral',
  ...
  {
    id: 'first_love_moved',
    description: 'First love moved away before they could say what needed saying — has been trying to say important things on time since',
    toneTag: 'cozy',
    statAffinity: { charisma: 1.1, wisdom: 1.1 },
  ...
  },
  {
    ...
    description: 'A serious illness meant repeating a year — a year behind everyone they started with',
    toneTag: 'dramatic',
  ...
  },
  {
    ...
    description: 'The family business failed when they were twelve — everything that followed was the aftermath',
    toneTag: 'gritty',
  ...
  {
    id: 'top_of_class',
    description: 'Was top of their middle school class — the pressure to stay there has never stopped',
    toneTag: 'neutral',
