...
export const QUIRKS = [
  ...
  },
  {
    id: "always_early",
    quirk:
      "Arrives everywhere early and becomes visibly agitated if forced to wait",
    statAffinity: { wisdom: 1.2, intelligence: 1.1 },
  },
  {
    id: "overexplains",
    quirk:
      "Over-explains things when nervous — can't stop once they've started",
  ...
  },
  {
    id: "counts_things",
    quirk:
      "Silently counts things in stressful situations — steps, tiles, ceiling panels",
  ...
  },
  {
    id: "constant_motion",
    quirk:
      "Always in motion — tapping, pacing, fidgeting — goes still only when something is very wrong",
  ...
  },
  {
    id: "mirror_check",
    quirk:
      "Checks their reflection in every reflective surface, almost unconsciously",
  ...
  // ── SPEECH PATTERNS ───────────────────────────────────────────────────
  {
    id: "long_pauses",
    quirk:
      "Pauses for an uncomfortably long time before answering any direct question",
  ...
  },
  {
    id: "talks_to_self",
    quirk:
      "Mutters to themselves while working through a problem — doesn't notice they're doing it",
    statAffinity: { intelligence: 1.3, wisdom: 1.1 },
  },
  {
    id: "deflects_with_humor",
    quirk:
      "Deflects anything serious with a joke — the worse the moment, the funnier the deflection",
    statAffinity: { charisma: 1.3, wisdom: 0.9 },
  },
  {
    id: "literal_thinker",
    quirk:
      "Takes figures of speech literally, then realizes it and overcorrects",
    statAffinity: { intelligence: 1.2, charisma: 0.9 },
  },
  {
  ...
  },
  {
    id: "never_first_name",
    quirk:
      "Never uses first names — everyone is addressed by surname, nickname, or nothing at all",
  ...
  // ── SOCIAL & BEHAVIORAL ───────────────────────────────────────────────
  {
    id: "remembers_orders",
    quirk:
      "Remembers exactly what everyone ordered or drank at their first meeting — years later",
  ...
  },
  {
    id: "fixes_things",
    quirk:
      "Compulsively fixes things that are slightly wrong — a crooked frame, an uneven stack of papers",
  ...
  },
  {
    id: "cant_let_go",
    quirk:
      "Can't leave an argument without getting the last word — even if it costs them",
    statAffinity: { strength: 1.1, wisdom: 0.8 },
  },
  {
    id: "overly_generous",
    quirk:
      "Gives away things they can't afford to — money, time, their last cigarette",
    statAffinity: { charisma: 1.2, wisdom: 0.8 },
  },
  {
    id: "invisible_in_crowds",
    quirk:
      "Has a talent for being completely overlooked in a crowd — can't decide if it's a gift or a curse",
  ...
  // ── OBJECTS & RITUALS ─────────────────────────────────────────────────
  {
    id: "specific_mug",
    quirk:
      "Will only drink coffee from one specific mug — the ritual is non-negotiable",
    statAffinity: { wisdom: 1.1, constitution: 1.1 },
  },
  {
    id: "carries_something",
    quirk:
      "Always carries one small object that has no practical use — never explains it",
    statAffinity: { wisdom: 1.2, charisma: 1.1 },
  },
  {
    id: "same_route",
    quirk:
      "Takes the exact same route everywhere, every time — detours cause visible distress",
    statAffinity: { wisdom: 1.1, intelligence: 1.1 },
  },
  {
    id: "hates_phones",
    quirk:
      "Refuses to leave a voicemail under any circumstances — will call back indefinitely instead",
    statAffinity: { charisma: 0.9, wisdom: 1.1 },
  },
  {
    id: "writes_everything",
    quirk:
      "Writes everything down — grocery lists, phone numbers, things people say — in a battered notebook",
    statAffinity: { intelligence: 1.3, wisdom: 1.1 },
  },
  ...
  },
  {
    id: "disappears",
    quirk:
      "Disappears for hours with no explanation, then returns like nothing happened",
    statAffinity: { wisdom: 1.1, charisma: 0.9 },
  },
  {
    id: "never_celebrates",
    quirk:
      "Can't celebrate wins — moves to the next problem before the last one is cold",
  ...
  },
  {
    id: "flinches",
    quirk:
      "Flinches at sudden movement on their left side — never mentions it, deflects if asked",
