...
"npcEntries": An object where every key is an NPC name and every value is a PLAIN STRING (not a nested object). Each string ~1000 chars — use the full length. Open with physical presence: age, build, distinguishing features, how they carry themselves in a room. Then personality through behavior — speech patterns, habits, tells, the thing you notice the third time you meet them. Reference the protagonist by name and show the relationship in action, not summary. These people should feel real enough to run into at a gas station.
