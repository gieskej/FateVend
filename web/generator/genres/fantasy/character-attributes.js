...
export const QUIRKS = [
  ...
  {
    quirk:
      "Always arrives early and becomes visibly agitated if forced to wait",
  ...
  {
    quirk:
      "Silently counts things in stressful situations — steps, stones, candles",
  ...
  {
    quirk:
      "Always in motion — tapping, pacing, fidgeting — goes completely still only when danger is near",
  ...
  {
    quirk:
      "Mutters to themselves while thinking — doesn't notice they're doing it",
  ...
  {
    quirk:
      "Gives away things they can't afford to — food, coin, their last torch",
  ...
  {
    quirk:
      "Carries one small object that has no practical use — never explains it",
    statAffinity: { wisdom: 1.2, charisma: 1.1 },
  },
  {
    quirk: "Laughs at the wrong moments — deaths, confessions, bad news",
  ...
  {
    quirk: "Flinches at sudden movement on their left side — never mentions it",
    statAffinity: { constitution: 0.9, strength: 1.1 },
  },
  // Fantasy-specific
  {
    quirk: "Checks their weapon's edge obsessively — even mid-conversation",
    statAffinity: { dexterity: 1.3, strength: 1.1 },
  },
  {
    quirk: "Refuses to sleep indoors if they can possibly avoid it",
    statAffinity: { wisdom: 1.2, constitution: 1.2 },
  },
  {
    quirk:
      "Mutters a quiet prayer before eating — even tavern slop that doesn't deserve one",
    statAffinity: { wisdom: 1.3 },
  },
  {
    quirk:
      "Has a deeply specific hatred of a particular monster — brings it up unprompted",
    statAffinity: { strength: 1.2, wisdom: 1.1 },
  },
  {
    quirk:
      "Compulsively maps new spaces — scratches diagrams in dirt or parchment margin",
    statAffinity: { intelligence: 1.3, dexterity: 1.1 },
  },
  {
    quirk:
      "Always knows which direction is north — insists on orienting everyone else, whether they asked or not",
    statAffinity: { wisdom: 1.3, intelligence: 1.1 },
  },
  {
    quirk:
      "Tastes unfamiliar liquids before identifying them — has not died yet",
    statAffinity: { constitution: 1.3, wisdom: 0.8 },
  },
  {
    quirk:
      "Apologizes to objects they damage — doors, walls, unfortunate furniture",
    statAffinity: { wisdom: 1.2, charisma: 1.1 },
  },
];
