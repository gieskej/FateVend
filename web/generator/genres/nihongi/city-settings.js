...
export const CITY_SETTINGS = [
  ...
  },
  {
    ...
    toneTag: 'gritty',
    iconPrompt: 'ancient japanese tsukushi kyushu frontier continental ships arriving watchpost defense something arrived on last ship that did not leave with the other passengers, nihon shoki yamato-e painting',
  ...
  },
  {
    ...
    toneTag: 'gritty',
    iconPrompt: 'ancient japanese emishi frontier northern honshu forest dark spirits of land not in yamato catalogue kami that do not recognize imperial authority watching garrison, nihon shoki yamato-e painting',
