...
// Locations in the Nihon Shoki / Asuka-period supernatural world. Each entry:
...
//   toneTag      — gritty | dramatic | cozy | neutral | horror | supernatural; feeds
//                  TAG_POOLS in settings.js
...
export const CITY_SETTINGS = [
  {
    ...
    toneTag: "dramatic",
    iconPrompt:
      "ancient japanese asuka imperial capital palace compound supernatural kami watching from wooded hills beyond eaves shadow figures at edge of torchlight, nihon shoki yamato-e painting",
    iconPath: "generator/genres/nihongi/icons/CITY_SETTINGS#asuka.webp",
    flavor:
      "The imperial palace and its surrounding clan compounds; every conversation is also a political act, and the kami of the land watch from the wooded hills immediately beyond the eaves — closer than they used to be, the older shrine priests say, and less patient",
  },
  {
    id: "naniwa",
    ...
    toneTag: "neutral",
    iconPrompt:
      "ancient japanese naniwa port harbor continental ships arriving foreign monks merchants something wrong in cargo not all passengers entirely human, nihon shoki yamato-e painting",
  ...
  },
  {
    ...
    toneTag: "cozy",
    iconPrompt:
      "ancient japanese yamato province kofun burial mounds glowing at night ancestral dead stirring rice paddies kami of land visible in mist, nihon shoki yamato-e painting",
    iconPath:
      "generator/genres/nihongi/icons/CITY_SETTINGS#yamato_province.webp",
    flavor:
      "The ancestral homeland of the Yamato court, dotted with kofun burial mounds whose occupants are old enough to have very different ideas about the current political arrangement; clan lineage claims are older than memory here, and some of the things those claims disturb have been asleep for a long time",
  },
  {
    id: "izumo",
    ...
    iconPrompt:
      "ancient japanese izumo grand shrine okuninushi dead gathering in autumn kami congress spirit roads converging fog, miko priests who can see things others cannot, nihon shoki yamato-e painting",
  ...
  },
  {
    ...
    toneTag: "supernatural",
    iconPrompt:
      "ancient japanese ise shrine amaterasu sacred forest wrong at night trees moving in no wind things that look like priests between the hinoki cypress, nihon shoki yamato-e painting",
  ...
  },
  {
    ...
    toneTag: "supernatural",
    iconPrompt:
      "ancient japanese kashihara sacred mountains spirit roads visible at night as light between peaks ancestor dead walking paths ancient shrines older than political system, nihon shoki yamato-e painting",
  ...
  },
  {
    ...
    toneTag: "horror",
    iconPrompt:
      "ancient japanese defiled ruined shrine kami corrupted or fled rope rotted offerings blackened stone cracked wrong cold feeling in approach, nihon shoki yamato-e painting",
    iconPath:
      "generator/genres/nihongi/icons/CITY_SETTINGS#defiled_shrine.webp",
    flavor:
  ...
  },
  {
    ...
    toneTag: "horror",
    iconPrompt:
      "ancient japanese sea cave coastal entrance to yomi underworld land of dead border thin between worlds dead figures visible through shimmer pale hands reaching from darkness within, nihon shoki yamato-e painting",
  ...
  },
  {
    ...
    toneTag: "gritty",
    iconPrompt:
      "ancient japanese tsukushi kyushu frontier continental ships arriving watchpost defense something arrived on last ship that did not leave with the other passengers, nihon shoki yamato-e painting",
    iconPath: "generator/genres/nihongi/icons/CITY_SETTINGS#tsukushi.webp",
    flavor:
      "The northwestern tip of Kyushu, where the straits to the Korean peninsula are narrow enough to seem crossable in bad weather; the court keeps military watchposts here because everything dangerous comes through Tsukushi first — including things that cross the water that were not on any manifest",
  },
  {
    id: "emishi_frontier",
    ...
    toneTag: "gritty",
    iconPrompt:
      "ancient japanese emishi frontier northern honshu forest dark spirits of land not in yamato catalogue kami that do not recognize imperial authority watching garrison, nihon shoki yamato-e painting",
    iconPath:
      "generator/genres/nihongi/icons/CITY_SETTINGS#emishi_frontier.webp",
    flavor:
