...
JSON SCHEMA:
{
  "characterEntry": "string (≤1000 chars) — open with one sentence: '[Full name] is a [age]-year-old [orientation] [gender] of [clan] with [hair length] [hair color] [hair style], [eye color] eyes, [skin tone] skin[, and any ritual markings, ornaments, or supernatural marks if notable], wearing [garment suited to their clan rank and profession].' Then describe personality, quirks, habits, occupation, relationships with family and key cast. Include what spirit or force is connected to them. Do not repeat the situation or plot.",
  ...
  "npcEntries": { "npc_name": "MAX 1000 chars. Open with one sentence: '[Full name] is a [age]-year-old [orientation] [gender] of [clan] with [hair length] [hair color] [hair style], [eye color] eyes, [skin tone] skin[, and any ritual markings, ornaments, or supernatural marks if notable], wearing [garment suited to their rank and role].' Then describe personality, quirks, habits, occupation, relationship with the protagonist and others, and their supernatural dimension — what entity or force is connected to them. Do not repeat the situation or plot." },
