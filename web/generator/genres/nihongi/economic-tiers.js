...
export const ECONOMIC_TIERS = {
  1: {
    ...
    iconPrompt:
      "ancient japanese outcast bondsman no clan bare feet rough cloth roadside humble survival nihon shoki yamato-e folk painting",
    iconPath:
      "generator/genres/nihongi/icons/ECONOMIC_TIERS#tier1-outcast.webp",
  },
  2: {
    label: "Peasant",
    descriptors: [
    ...
    iconPrompt:
      "ancient japanese free farmer tami rice paddy village communal simple honest labour nihon shoki yamato-e folk painting",
    iconPath:
      "generator/genres/nihongi/icons/ECONOMIC_TIERS#tier2-peasant.webp",
  },
  3: {
    ...
    iconPrompt:
      "ancient japanese minor official craftsman shrine keeper modest robes respectful functional nihon shoki yamato-e painting",
    iconPath:
      "generator/genres/nihongi/icons/ECONOMIC_TIERS#tier3-minor-official.webp",
  },
  4: {
    ...
    iconPrompt:
      "ancient japanese court retainer official silk layered robes lacquered furniture asuka period prosperity court nihon shoki yamato-e painting",
    iconPath:
      "generator/genres/nihongi/icons/ECONOMIC_TIERS#tier4-court-retainer.webp",
  },
  5: {
    label: "Great Lord",
    descriptors: [
    ...
    iconPrompt:
      "ancient japanese great clan lord omi muraji grand compound silk robes escort prestige asuka court nihon shoki yamato-e court painting",
    iconPath:
      "generator/genres/nihongi/icons/ECONOMIC_TIERS#tier5-great-lord.webp",
  },
};
