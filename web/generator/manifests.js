...
import { SYSTEM_PROMPT as MODERN_SYSTEM_PROMPT,   outputRules as modernOutputRules }  from './genres/modern/voice.js';
import { SYSTEM_PROMPT as FANTASY_SYSTEM_PROMPT,  outputRules as fantasyOutputRules } from './genres/fantasy/voice.js';
import { SYSTEM_PROMPT as SCIFI_SYSTEM_PROMPT,    outputRules as scifiOutputRules }   from './genres/sci-fi/voice.js';
import { SYSTEM_PROMPT as PALEO_SYSTEM_PROMPT,    outputRules as paleoOutputRules }   from './genres/paleolithic/voice.js';
import { SYSTEM_PROMPT as MANGA_HS_SYSTEM_PROMPT, outputRules as mangaHsOutputRules } from './genres/manga-osaka-highschool1987/voice.js';
import { SYSTEM_PROMPT as JOSEON_SYSTEM_PROMPT,   outputRules as joseonOutputRules }  from './genres/historical-korea-joseon-dynasty/voice.js';
import { SYSTEM_PROMPT as NIHONGI_SYSTEM_PROMPT,  outputRules as nihongiOutputRules } from './genres/nihongi/voice.js';
