...
export const NPC_TRAITS = [
  "fiercely loyal",
  "surprisingly funny",
  "the most reliable person alive",
  ...
  "weirdly calm under pressure",
  "charming and unreliable",
  "protective",
  "impulsive",
  "pragmatic",
  "idealistic",
  ...
  "stubborn",
  "unpredictable",
  "hot-tempered but quick to apologize",
  "means well, executes poorly",
  ...
  "would help hide a body, no questions asked",
  "keeps a running list of people who've wronged them",
  "morally flexible on a good day",
  "knows where all the bodies are buried — sometimes literally",
  "loyal right up until the math changes",
  "collects secrets like other people collect debts",
  "disturbingly good at getting into locked places",
  "would take a bullet for you, then never let you forget it",
  "cheerfully amoral",
  "petty in ways that are almost impressive",
  "treats every conversation like a negotiation",
  "unsettlingly perceptive",
  "has a plan for when it all goes wrong",
  "never forgets a face, a name, or a favor owed",
  "the calm one, which is somehow more alarming",
  "asks 'whose funeral?' before 'what happened?'",
  "believes rules are suggestions for other people",
  "dangerously persuasive",
  "has burned every bridge but one",
  "keeps a go-bag packed and won't say why",
  "would rather be feared than misunderstood",
  "lies for practice, not just profit",
];
...
export const FOIL_ROLES = [
  {
    ...
    dynamics: [
      ...
      "Grew up alongside {n}; the competition technically never ended",
