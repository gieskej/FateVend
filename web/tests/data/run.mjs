...
// every genre/table), music manifest/disk agreement, and a bulk-roll
// consistency check (50 rolls/genre). All are near-instant (well under a second
// combined), so they're folded into the default `npm test` ahead of the
// browser-driven e2e tier in web/tests/e2e/run.mjs.

import * as iconFiles from "./icon-files.mjs";
import * as musicFiles from "./music-files.mjs";
import * as bulkRoll from "./bulk-roll.mjs";

async function main() {
  let totalPass = 0;
  let totalCount = 0;
  for (const suite of [iconFiles, musicFiles, bulkRoll]) {
